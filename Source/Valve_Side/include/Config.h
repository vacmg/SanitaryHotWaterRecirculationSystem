...
constexpr float VALVE_OPEN_DELTA_THRESHOLD = 3.0; // minimum °C rise from progressMinTemp required to open the valve early; pump continues until HOT_WATER_TEMPERATURE_MULTIPLIER threshold.
