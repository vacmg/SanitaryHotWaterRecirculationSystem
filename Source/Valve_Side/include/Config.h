...
#define EEPROM_CLEAR_ON_BUILD_ID_CHANGE 1
#define EEPROM_MODE_ADDRESS 0
#define EEPROM_FALLBACK_MODE_ENABLED_ADDRESS 8
#define EEPROM_ERROR_COUNTER_ADDRESS 12
...
constexpr uint16_t ERROR_COUNT_TO_ENABLE_FALLBACK_MODE = 5;
...
constexpr unsigned long FALLBACK_ERROR_COUNTER_RESET_TIMEOUT_MS = 1800000UL; // 30 min
...
constexpr int FLASH_EMERGENCY_SHUTDOWN_COLOR_PERIOD = 500; // 500 ms
