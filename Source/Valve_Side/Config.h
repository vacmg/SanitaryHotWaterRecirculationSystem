...
const float MIN_ALLOWED_PRESSURE_SENSOR_CURRENT_mA = 0.5; // mA
const float MAX_ALLOWED_PRESSURE_SENSOR_CURRENT_mA = 6; // mA
...
const double WATER_MIN_NORMAL_PRESSURE_BAR = 2.0;
const double PRESSURE_SENSOR_CURRENT_MIN_mA = 0.75;
const double PRESSURE_SENSOR_CURRENT_MAX_mA = 4.0;
